...
public class PageRank {
  ...
  public static class PageRankVertex extends
    ...
    public void compute(Iterable<DoubleWritable> messages) throws IOException {
        ...
        aggregate(0, this.getValue());
            ...
            System.out.println(this.getSuperstepCount() + " COMPUTATION FOR VERTEX: " + this.getVertexID());
      }
  ...
  public static GraphJob createJob(String[] args, HamaConfiguration conf,
    ...
    if (cliParser.hasOption("t")) {
      ...
      System.out.println(pageJob.getNumBspTask()+ " NUMERO DI PEER IN ESECUZIONE");
    // error
    ...
    pageJob.setOutputValueClass(DoubleWritable.class);
      System.out.println(pageJob.getNumBspTask() + " TASK ATTIVI PR");
    return pageJob;
  }
